---
name: testing
description: "Правила написания тестов для проекта CS Platform. E2E тесты Playwright, паттерны, моки PostgreSQL/PostgREST. Обязательно используй когда пользователь говорит 'напиши тест', 'добавь тесты', 'протестируй', 'e2e', 'playwright', или когда нужно проверить функциональность через автотесты."
---
