...
// PostgREST direct access via WG/MikroTik (DB VPS internal IP, direct mode — no /rest/v1 suffix)
process.env.POSTGREST_URL = 'http://10.0.0.3:3000';
process.env.POSTGREST_DIRECT = '1';
process.env.NEXT_PUBLIC_API_URL = 'http://10.0.0.3:3000';
...
process.env.POSTGREST_JWT_SECRET = process.env.POSTGREST_JWT_SECRET || '';
