...
import { ActivityEvent } from '@/lib/ops';
    ...
    return (
        <div className="glass-card rounded-3xl border border-white/40 bg-white/60 backdrop-blur-xl shadow-sm overflow-hidden min-h-[400px]">
            ...
            {loading ? (
                        ...
                        <div key={i} className="flex gap-3 px-2 py-2">
                            ...
                            <div className="flex-1 space-y-2">
                                ...
                                <div className="flex gap-1.5">
                                    <Skeleton className="h-5 w-32 rounded-md bg-slate-100" />
                ...
                <div className="overflow-y-auto max-h-[800px] scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
                    {dateGroups.map((group) => (
                        <div key={group.dateKey} className="relative">
                            {/* Date header */}
                            <div className="sticky top-0 z-10 px-6 py-2 bg-white/90 backdrop-blur-md border-b border-slate-50 text-xs font-bold text-slate-400 uppercase tracking-wider shadow-sm">
                                {group.dateLabel}
                            </div>
