  ...
  if (history.length === 0) {
    return (
      <EmptyState
        ...
        title="Нет данных об инфраструктуре"
          ...
          <tbody className="bg-white divide-y divide-slate-200">
            {history.map((item, index) => (
              ...
              >
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <span className="text-sm text-slate-600 truncate max-w-[140px] inline-block" title={item.contract_number || undefined}>
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  <span className="text-sm text-slate-600 truncate max-w-[120px] inline-block" title={item.director || undefined}>
                    {item.director || '—'}
                  </span>
                </td>
                <td className="px-4 py-3 whitespace-nowrap text-right">
                        ...
                        confirmDeleteId === item.infrastructure_id ? (
                          <div className="flex items-center gap-0.5 bg-red-50 rounded-lg px-0.5 py-0.5 animate-fade-in">
                            <button
                              ...
                              title="Отмена"
                              className="p-1 hover:bg-red-100 rounded-lg transition-colors text-slate-500 hover:text-slate-700"
                            >
