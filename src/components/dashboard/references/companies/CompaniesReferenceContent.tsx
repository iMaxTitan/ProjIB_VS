...
import InfrastructureChart from './infrastructure/InfrastructureChart';
import InfrastructureHistoryTable from './infrastructure/InfrastructureHistoryTable';
...
export default function CompaniesReferenceContent({ user, tabsSlot }: { user: UserInfo; tabsSlot?: React.ReactNode }) {
  ...
  const canDelete = user.role === 'chief' || user.role === 'head';
        ...
        return (
          ...
          >
            <div className="flex items-center gap-3">
              <div className={cn('w-2 h-2 rounded-full flex-shrink-0', company.has_servers ? 'bg-purple-500' : 'bg-slate-300')} />
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  {!isFresh && company.period_year && (
                    <Badge variant="amber" size="sm">Устарело</Badge>
                  )}
                </div>
                {company.director && (
                ...
                <div className="flex items-center gap-3 mt-1 text-xs text-slate-500">
                  ...
                  {company.period_year && company.period_month && (
                    <Badge variant={isFresh ? 'success' : 'slate'} size="sm">
