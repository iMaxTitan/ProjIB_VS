            ...
            <table className="w-full text-sm" aria-label="Таблиця моїх планів">
              <thead>
                <tr className="border-b border-slate-200">
                  <th scope="col" className="text-left py-2 px-2 sm:px-3 text-slate-600 font-medium">Процедура</th>
                ...
                {myPlans.map((plan) => (
                  <tr key={plan.planId} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                    <td className="py-2 px-2 sm:px-3">
                      <div className="font-medium text-slate-800 truncate max-w-[180px] sm:max-w-[250px]" title={plan.procedureName}>
                        {plan.procedureName}
                      </div>
