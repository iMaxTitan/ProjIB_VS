/**
 * GET    /api/planner/templates?procedure_id=X  — list active templates
 * POST   /api/planner/templates                 — create template (chief/head)
 * PATCH  /api/planner/templates                 — update template (chief/head)
 * DELETE /api/planner/templates?id=X            — soft-delete template (chief/head)
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    logger.error('[planner/templates] GET error:', err);
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    logger.error('[planner/templates] POST error:', err);
    return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
  }
}
...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    logger.error('[planner/templates] PATCH error:', err);
    return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
  }
}
...
export async function DELETE(req: NextRequest) {
  ...
  try {
    ...
    logger.error('[planner/templates] DELETE error:', err);
    return NextResponse.json({ error: 'Internal Server Error' }, { status: 500 });
  }
}
